...
class BookTest < ActiveSupport::TestCase
  test "search_google_books returns empty array when query is blank" do
    results = Book.search_google_books("")
    assert_equal [], results
  end

  test "search_google_books returns empty array when query is nil" do
    results = Book.search_google_books(nil)
    assert_equal [], results
  end

  test "search_google_books returns array of book data" do
    mock_response = {
      "items" => [
        {
          "id" => "test123",
    ...
    results = Book.search_google_books("テスト")
  ...
  test "search_google_books handles API errors gracefully" do
    stub_request(:get, /googleapis.com/)
      .to_return(status: 500, body: "Internal Server Error")

    results = Book.search_google_books("test")
    assert_equal [], results
  end
end
